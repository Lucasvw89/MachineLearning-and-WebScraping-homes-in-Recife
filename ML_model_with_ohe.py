...
X = pd.get_dummies(homes_data[homes_ML_model_features])
...
print(mean_absolute_error(val_y, validation_predictions))       # aproximadadmente 260 000 reais de margem de erro
